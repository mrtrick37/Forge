...
`build_files/config/runtime-migration-report.json` now lists 22 active Python
...
- [x] Add regression coverage for surviving Python entry points, direct
  ...
  checked-in inventory/report now show 22 active Python package entries (down
  from 157 non-superseded package files) and 127 unreachable shared-package
  fixtures.
...
**Status: in progress (5/46 complete).** This is the remaining Python half of
